                ...
                <ul className="nav navbar-nav nav-flex-icons ml-auto">
                    <li className="nav-item dropdown">
                        ...
                        <div className="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu1">
                            <a className="dropdown-item waves-effect waves-light">Sign Up </a>
                            <a className="dropdown-item waves-effect waves-light">Sign in</a>
                            <a className="dropdown-item waves-effect waves-light">Sign Out</a>
                        </div>
                    </li>
                </ul>
